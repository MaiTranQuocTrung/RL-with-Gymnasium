...
dueling = DuelingNet(input_size=state_space, action_space=action_space, hidden_size=512)
...
DQN.train_model(model=mlp, model_id="mlp", solved_threshold=260, success_threshold=200,
                env_id=env_id, sync_freq=500, min_sample=2500, model_learning_rate=0.0007,
                self_train_itr=1000, eps_steps_decay= 50_000)
